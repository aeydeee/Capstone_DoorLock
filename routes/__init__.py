from routes.admin.program_routes import program_bp
...
from routes.admin.course.course_routes import course_bp
...
from .admin.course.add_course_per_program import add_course_per_program_bp
...
def register_blueprints(app):
    ...
    app.register_blueprint(add_course_per_program_bp, url_prefix='/add_course_per_program')
